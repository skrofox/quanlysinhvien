                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="summary" id="summary" rows="3"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors">{{ old('summary', $news->summary) }}</textarea>
                            </div>

                            <div class="mb-6">
                                <label for="content" class="block text-sm font-medium text-gray-700 mb-2">Nội dung chi tiết</label>
                                <div id="editor-container">
                                    <textarea name="content" id="editor" class="hidden">{{ old('content', $news->content) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <select name="status" id="status" required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors">
                                    <option value="published" {{ old('status', $news->status) == 'published' ? 'selected' : '' }}>Công khai</option>
                            ...
                            <div class="mb-6">
                                ...
                                @if($news->thumbnail)
                                    <div class="mb-4">
                                        <img src="{{ $news->thumbnail }}" alt="Current Thumbnail" class="h-32 w-full object-cover rounded-md border">
                                        <p class="text-xs text-gray-400 mt-1">Hình hiện tại</p>
                                    </div>
                                @endif
                                ...
                                <p class="mt-2 text-xs text-gray-400">Định dạng: JPG, PNG, GIF. Tối đa 2MB. Để trống nếu không muốn đổi.</p>
                            </div>
